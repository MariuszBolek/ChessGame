...
public class MoveService {
    ...
    public boolean isDrawAcceptable(Game game) {
        ...
        PieceColor opponentColor = game.getToPlay();
        PieceColor color = swap(opponentColor);
    ...
    private MoveAnalysis selectMove(Board board, PieceColor color, List<Move> history, int depth, boolean isTopDepth,
        ...
        final PieceColor opponentColor = swap(color);
    ...
    private MoveAnalysis computeMoveAnalysis(Board board, PieceColor color, List<Move> history, int depth,
                                             PieceColor opponentColor, Position opponentKingPosition, Position myKingOriginalPosition, Move move,
                                             LocalDateTime computationTimeout) {
    ...
    Optional<Position> findKingPosition(Board board, PieceColor color) {
    ...
    int evaluateBoard(Board board, PieceColor colorToEvaluate, PieceColor lastPlayer, GameState gameState, Position opponentKingPosition, Position myKingPosition, List<Move> history) {
    ...
    private int getPiecesScore(Board board, PieceColor color) {
    ...
    int getHeatScore(Board board, PieceColor color, Position opponentKingPosition, Position myKingPosition,
                     List<Move> history) {
    ...
    int getDevelopmentScore(PieceColor color, List<Move> history) {
    ...
    int getPiecesValueSum(Board board, PieceColor color) {
        int sum = 0;
    ...
    boolean isInCheck(Board board, PieceColor color) {
    ...
    boolean isValidSituation(Board boardAfterMove, PieceColor color) {
